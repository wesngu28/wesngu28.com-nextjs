    ...
    return (
        <div className="w-[75vw] mt-11">
            ...
            <ul className="grid grid-cols md:grid-cols-2 lg:grid-cols-4">
                <GameCard name={'Skyrim'} cover={skyrimCover} url={'https://elderscrolls.bethesda.net/en/skyrim'} stats={skyrimStats} />
                <GameCard delay='lg:delay-100' name={'Hearts of Iron IV'} cover={hoi4Cover} url={'https://www.paradoxinteractive.com/games/hearts-of-iron-iv/about'} stats={hoi4Stats} />
                <GameCard delay='lg:delay-200' name={'Super Auto Pets'} cover={sapCover} url={'https://teamwoodgames.com/'} stats={sapStats} />
                <GameCard delay='lg:delay-300' name={'League of Legends'} cover={leagueCover} url={'https://www.leagueoflegends.com/en-us/'} stats={leagueStats} />
                <GameCard delay='lg:delay-[400ms]' name={'Starcraft II'} cover={sc2Cover} url={'https://starcraft2.com/en-us/'} stats={sc2Stats} />
                <GameCard delay='lg:delay-500' name={'Civilization V'} cover={civCover} url={'https://civilization.com/civilization-5/'} stats={civStats} />
                <GameCard delay='lg:delay-[600ms]' name={'Arknights'} cover={akCover} url={'https://www.arknights.global/'} stats={akStats} /> 
                <GameCard delay='lg:delay-700' name={'Azur Lane'} cover={alCover} url={'https://azurlane.yo-star.com/#/'} stats={alStats} />
            </ul>
        </div>
    )
}
