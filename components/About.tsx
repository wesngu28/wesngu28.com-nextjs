  ...
  return (
    <div className="md:flex justify-center items-center p-4 bg-[#1F2022] w-full relative">
      <div className="md:p-4 w-full md:w-[75vw] lg:w-[55vw] m-auto flex justify-center items-center flex-col">
        ...
        <p className="md:p-4 text-left text-md md:text-xl leading-8">{paragraph1}</p>
        <p className="md:p-4 text-left text-md md:text-xl leading-8">{paragraph2}</p>
      ...
      <div className="flex flex-col items-center">
        <div className="w-3/5">
          <Image
            className="p-4 rounded-full mx-auto object-cover"
            alt="photo of me"
            src={me}
          />
        </div>
        <ul className="list-none flex flex-wrap items-center justify-center">
          ...
          <NavLink
            img={linkedin}
            name="linkedin"
            url="https://www.linkedin.com/in/wesngu28/"
          />
