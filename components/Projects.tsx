    ...
    return (
        <div className="w-[85vw] mt-11">
            ...
            <ul className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <ProjectCard techs={['Typescript', 'Tailwind', 'React', 'Next.js', 'Mapbox']} url={'https://github.com/wesngu28/rhodesapi'} image={'personal-web.png'}name={'Personal Website'} desc={'This very own website. I learned a lot about Tailwind through this project and got more exposure with the Next.js framework.'} />
                ...
                <ProjectCard techs={['Python, Tkinter']} url={'https://github.com/wesngu28/Twitter-Translator'} image={'translator.png'} name={'Translatter'} desc={'A website that allows you to paste in a Spotify artist, track, playlist, or album, and get some information about them and also receive a table with YouTube links of the songs inside of it or recommendations. Also allows for you to login and get information about your listening habits.'} />
            </ul>
        </div>
    )
}