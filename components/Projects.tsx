    ...
    return (
        <div className="w-[85vw] mt-11">
            ...
            <ul className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <ProjectCard techs={['Typescript', 'Tailwind', 'React', 'Next.js', 'Mapbox']} live={'https://wesngu28.com'} url={'https://github.com/wesngu28/wesngu28.com'} image={personalWebsite} name={'Personal Website'} desc={'This very own website. I learned a lot about Tailwind through this project and got more exposure with the Next.js framework.'} />
